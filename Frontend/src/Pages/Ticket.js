...
import { MdAdd, MdEventNote, MdHorizontalRule, MdOutlineHorizontalDistribute, MdRadioButtonChecked } from "react-icons/md";
...
const handleValue = (a)=>{
    ...
    return (
        <div className="ticket-super-container">
            ...
            <div className="ticket-data-container" style={{padding: '5%'}}>
                ...
                <h4 style={{ fontFamily: 'Futura-bold', textAlign: 'center'}} >Order Summary</h4>
                <br />
                <br />
                    ...
                    <Row style={{ fontFamily: 'Futura-medium' }}>
                        ...
                        <Col>
                            <Row style={{ width: '125px' }}>
                                <div>
                                    {/* <label></label> */}
                                    <input style={{marginLeft:"10rem"}} value={number} onChange={handleChange}></input>
                                    
                                </div>
                            </Row>
                            <button onClick={handleDec}><MdHorizontalRule style={{ fontSize: '25px', paddingRight: "2px"}} /></button>
                            <button onClick={handleClick} style={{marginLeft: '20px', marginRight:"-5px"}}><MdAdd style={{ fontSize: '25px', paddingRight: "2px"}} /></button>
                        </Col>
                        <Col><Row style={{width: '125px', marginLeft:"9rem"}}><input value={events && filtered?.Ticket_Price} onChange={handleChange}></input></Row></Col>
                    </Row>
                    <br />
                    <Row style={{ fontFamily: 'Futura-bold' }}>
                        <Col>Sub Total</Col>
                        <Col>  </Col>
                        <Col><Row style={{width: '125px', marginLeft:"9rem"}}><input value={price} onChange={handleChange}></input></Row></Col>
                    </Row>
                    <Row style={{ fontFamily: 'Futura-bold' }}>
                        <Col>Delivery Cost</Col>
                        <Col>  </Col>
                        <Col><Row style={{width: '125px', marginLeft:"9rem"}}><input value={events && filtered?.Delivery_Charge} onChange={handleChange}></input></Row></Col>
                    </Row>
                    <Row style={{ fontFamily: 'Futura-bold'}}>
                        <Col>Total</Col>
                        <Col>  </Col>
                        <Col><Row style={{width: '125px', marginLeft:"9rem"}}><input value={total} onChange={handleChange} ></input></Row></Col>
                    </Row>
                </Container>
                <br /><br /><br />
                <h4 style={{ fontFamily: 'Futura-bold', marginLeft: '110px'}}>Delivery Information</h4>
            ...
            <Col>Payment Method</Col>
                    ...
                    <FormControl>
                        <FormLabel id="demo-controlled-radio-buttons-group" style={{ fontFamily: 'Futura-bold', fontSize: "20px" }}>Payment Method:</FormLabel>
                        <RadioGroup
        ...
        <Row style={{fontFamily:'Futura-medium'}}>
            <Col><MdRadioButtonUnchecked/>Credit Card</Col>
                    ...
                    <Row style={{ fontFamily: 'Futura-medium' }}>
                        ...
                        <Col></Col>
                        <Col></Col>
                        <Col><button className="confirm-ticket" onClick={submit} style={{marginLeft:'5rem'}}>Confirm Order</button></Col>
                    </Row>
                </Container>
            </div>
        </div>
